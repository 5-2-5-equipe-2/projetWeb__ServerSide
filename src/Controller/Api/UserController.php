    ...
    class UserController extends BaseController
    {
        ...
        public function updatePassAction()
        {
            ...
            try {
                ...
                $queryArgs = $this->getRequiredPutArgsOrThrow(array('old_password', 'new_password'), array('string', 'string'));
                $userManager = new UserManager();
                $userManager->updatePassword($queryArgs['old_password'], $queryArgs['new_password']);
        ...
        /**
         * Search in user's chatRooms
         *
         */
        public function searchChatRoomsAction()
        {
            $strErrorDesc = '';
            $responseData = array();
            $strErrorHeader = '';
            try {
                ...
                $this->isRequestMethodOrThrow('GET');
                $userModel = new UserModel();
                $queryArgs = $this->getRequiredGetArgsOrThrow(array('userId', 'search'), array('number', 'string'));
                $result = $userModel->searchUserChatroom($queryArgs['userId'], $queryArgs['search']);
